...
from PyQt6.QtGui import (QIcon, QColor, QFont, QTransform, QPixmap,
                         QPainter, QImage, QPen, QFontMetrics)
...
from config import (
    AppConfig, log, load_json, secure_load_json, ensure_dir, sanitize_filename, apply_tooltips,
    resource_path, f_global_ach, f_achievements_state, APP_DIR,
)
from input_manager import (
    vk_to_name, vk_to_name_en,
    JOYINFOEX, JOY_RETURNALL, JOYERR_NOERROR, _joyGetPosEx,
    WM_KEYDOWN, WM_SYSKEYDOWN, WM_HOTKEY,
    GlobalKeyHook, get_vpx_ini_path_for_current_user, parse_vpx_flipper_bindings,
    register_raw_input_for_window,
)
from cloud import CloudSync
from process_manager import Watcher
from overlays import (
    OverlayWindow, MiniInfoOverlay, FlipCounterOverlay, read_active_players,
    FlipCounterPositionPicker, TimerPositionPicker, ToastPositionPicker,
    ChallengeOVPositionPicker, MiniInfoPositionPicker, OverlayPositionPicker,
)
from achievements import AchToastWindow, AchToastManager
from challenges import ChallengeCountdownOverlay, ChallengeSelectOverlay, FlipDifficultyOverlay

# ---------------------------------------------------------------------------
# Signal bridge between Watcher and MainWindow
# ---------------------------------------------------------------------------
