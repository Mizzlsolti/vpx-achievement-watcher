...
"""
        ...
        readme_content = (
            ...
            f"INSTALLATION:\n"
            f"{thin}\n"
            f"1. Copy \"{vbs_name}\" next to your .vpx table file\n"
            f"   (into your Tables folder)\n"
            f"\n"
            f"2. Open the table in VPX Editor (File > Open)\n"
            f"\n"
            f"3. Open Script Editor (View > Script or F12)\n"
            f"\n"
            f"4. Add these lines near the TOP of your table script:\n"
            f"\n"
            f"     On Error Resume Next\n"
            f"     ExecuteGlobal GetTextFile(\"{vbs_name}\")\n"
            f"     On Error Goto 0\n"
            f"\n"
            f"5. Add FireAchievement calls inside the corresponding Subs in your\n"
            f"   table script (see below).\n"
            f"\n"
            ...
            f"{'─' * 28}\n"
            f"For each detected event, add the FireAchievement call inside the\n"
            f"corresponding Sub in your table script:\n"
            f"\n"
            f"{detected_section}\n"
            f"\n"
            f"\n"
