...
from config import (
    AppConfig, log, load_json, save_json, secure_save_json, secure_load_json,
    write_text, ensure_dir, sanitize_filename,
    _fetch_bytes_url, _fetch_json_url, _is_weird_value,
    is_excluded_field,
    p_maps, p_local_maps, p_session, p_highlights, p_rom_spec, p_custom,
    f_global_ach, f_achievements_state, f_log, f_index, f_romnames,
    APP_DIR, VPXTOOL_PATH, VPXTOOL_URL,
...
from input_manager import (
    ...
    RAWINPUTDEVICE, RIDEV_INPUTSINK, WM_KEYDOWN, WM_SYSKEYDOWN, WM_HOTKEY,
    _RegisterRawInputDevices, vk_to_name, vk_to_name_en, vsc_to_vk,
...
# ---------------------------------------------------------------------------
# Watcher – main process & session manager
# ---------------------------------------------------------------------------
