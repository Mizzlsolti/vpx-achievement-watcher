...
DEFAULT_OVERLAY.setdefault("anim_main_transitions", False)
DEFAULT_OVERLAY.setdefault("anim_main_glow", False)
DEFAULT_OVERLAY.setdefault("anim_main_score_progress", False)
DEFAULT_OVERLAY.setdefault("anim_main_highlights", False)
DEFAULT_OVERLAY.setdefault("anim_toast", False)
DEFAULT_OVERLAY.setdefault("anim_status", False)
...
# Main Overlay
DEFAULT_OVERLAY.setdefault("fx_main_breathing_glow", False)
DEFAULT_OVERLAY.setdefault("fx_main_breathing_glow_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_main_floating_particles", False)
DEFAULT_OVERLAY.setdefault("fx_main_floating_particles_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_main_page_transition", False)
DEFAULT_OVERLAY.setdefault("fx_main_glitch_frame", False)
DEFAULT_OVERLAY.setdefault("fx_main_score_spin", False)
DEFAULT_OVERLAY.setdefault("fx_main_progress_fill", False)
DEFAULT_OVERLAY.setdefault("fx_main_shine_sweep", False)
DEFAULT_OVERLAY.setdefault("fx_main_highlight_flash", False)
DEFAULT_OVERLAY.setdefault("fx_main_nav_arrows_pulse", False)
DEFAULT_OVERLAY.setdefault("fx_main_accent_lerp", False)

# Achievement Toast
DEFAULT_OVERLAY.setdefault("fx_toast_burst_particles", False)
DEFAULT_OVERLAY.setdefault("fx_toast_burst_particles_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_toast_neon_rings", False)
DEFAULT_OVERLAY.setdefault("fx_toast_neon_rings_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_toast_typewriter", False)
DEFAULT_OVERLAY.setdefault("fx_toast_icon_bounce", False)
DEFAULT_OVERLAY.setdefault("fx_toast_slide_motion", False)
DEFAULT_OVERLAY.setdefault("fx_toast_energy_flash", False)
DEFAULT_OVERLAY.setdefault("fx_toast_god_rays", False)
DEFAULT_OVERLAY.setdefault("fx_toast_god_rays_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_toast_confetti", False)
DEFAULT_OVERLAY.setdefault("fx_toast_confetti_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_toast_hologram_flicker", False)
DEFAULT_OVERLAY.setdefault("fx_toast_shockwave", False)
...
DEFAULT_OVERLAY.setdefault("fx_duel_breathing_glow", False)
DEFAULT_OVERLAY.setdefault("fx_duel_breathing_glow_intensity", 80)
DEFAULT_OVERLAY.setdefault("fx_duel_slide_motion", False)
DEFAULT_OVERLAY.setdefault("fx_duel_energy_flash", False)
DEFAULT_OVERLAY.setdefault("fx_duel_color_morph", False)
DEFAULT_OVERLAY.setdefault("fx_duel_glow_sweep", False)
...
DEFAULT_OVERLAY.setdefault("trophie_gui_enabled", False)
DEFAULT_OVERLAY.setdefault("trophie_overlay_enabled", False)
...
DEFAULT_OVERLAY.setdefault("pp_overlay_main", False)
