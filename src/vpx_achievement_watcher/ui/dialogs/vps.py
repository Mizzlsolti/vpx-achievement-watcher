...
def _load_vpsdb(cfg) -> Optional[List[dict]]:
    ...
    from vpx_achievement_watcher.core.paths import f_vpsdb_cache
...
def _load_vps_mapping(cfg) -> dict:
    ...
    from vpx_achievement_watcher.core.paths import f_vps_mapping
...
class VpsPickerDialog(QDialog):
    ...
    def __init__(self, cfg, tables: List[dict], rom: str, table_title: str, parent=None):
        ...
        from vpx_achievement_watcher.core.paths import p_vps_img
