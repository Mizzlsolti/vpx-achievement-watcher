...
# ---------------------------------------------------------------------------
# 2. TimerPositionPicker
# ---------------------------------------------------------------------------

class TimerPositionPicker(_BasePositionPicker):
    def _picker_label(self) -> str:
        return "Challenge Timer"

    def _config_saved_key(self) -> str:
        return "ch_timer_saved"

    def _config_fallback_saved_key(self) -> str | None:
        return "ch_timer_custom"

    def _config_x_portrait_key(self) -> str:
        return "ch_timer_x_portrait"

    def _config_y_portrait_key(self) -> str:
        return "ch_timer_y_portrait"

    def _config_x_landscape_key(self) -> str:
        return "ch_timer_x_landscape"

    def _config_y_landscape_key(self) -> str:
        return "ch_timer_y_landscape"
...
class ChallengeOVPositionPicker(_BasePositionPicker):
    def _picker_label(self) -> str:
    ...
    def _config_x_portrait_key(self) -> str:
        return "ch_ov_x_portrait"

    def _config_y_portrait_key(self) -> str:
        return "ch_ov_y_portrait"

    def _config_x_landscape_key(self) -> str:
        return "ch_ov_x_landscape"

    def _config_y_landscape_key(self) -> str:
        return "ch_ov_y_landscape"
...
class HeatBarPositionPicker(_BasePositionPicker):
    ...
    def _config_saved_key(self) -> str:
        return "heat_bar_saved"

    def _config_fallback_saved_key(self) -> str | None:
        return "heat_bar_custom"

    def _config_x_portrait_key(self) -> str:
        return "heat_bar_x_portrait"

    def _config_y_portrait_key(self) -> str:
        return "heat_bar_y_portrait"

    def _config_x_landscape_key(self) -> str:
        return "heat_bar_x_landscape"

    def _config_y_landscape_key(self) -> str:
        return "heat_bar_y_landscape"
