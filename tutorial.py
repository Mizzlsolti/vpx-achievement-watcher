...
_STEPS = [
    ...
    },
    {
        ...
        "body": (
            ...
            "Preview buttons:\n"
            "  • ▶ Preview — opens the overlay in demo mode with all\n"
            "    enabled effects running for 6 seconds, then auto-closes\n\n"
    ...
    },
    {
        ...
        "body": (
            ...
            "How it works:\n"
            "  1. Go to the Score Duels tab → My Duels\n"
            "  2. Select a player and table, then send the invitation\n"
            "  3. Both players play the same table independently\n"
            "  4. Highest score wins!\n\n"
            "Receiving invitations:\n"
            "  • If the GUI is open: the Score Duels tab switches\n"
            "    automatically to show the invitation\n"
            "  • If minimized to tray: a notification overlay appears.\n"
            "    Navigate with Challenge hotkeys (Left/Right) and\n"
            "    confirm with the Challenge hotkey.\n\n"
            "  ⏳ Notifications auto-hide after 60s (no auto-decline).\n"
            ...
            "  The system matches you with someone who has the same\n"
            "  tables installed. A random shared table is picked!\n\n"
            "🌍 Global Feed:\n"
            "  Check the Global Feed sub-tab to see the latest\n"
            "  completed duels from all players in the community!"
        ),
        "tab": 6,   # Score Duels
        "subtab": None,
    },
