...
class MainWindow(QMainWindow, CloudStatsMixin, AWEditorMixin, SystemMixin, AppearanceMixin, ChallengesMixin, ProgressMixin,
    ...
    _TAB_HELP = {
        ...
        "appearance_effects": (
            ...
            "Screen-space effects applied on top of all overlays. Require OpenGL. "
            "Disabled automatically in Low Performance Mode.<br>"
            ...
            "• <b>Scanlines</b>: Overlays horizontal lines to simulate a classic CRT monitor screen.<br><br>"
