...
class MainWindow(QMainWindow, CloudStatsMixin, AWEditorMixin, SystemMixin, AppearanceMixin, ChallengesMixin, ProgressMixin,
    ...
    _TAB_HELP = {
        ...
        "appearance_effects": (
            ...
            "enabled effects running for 6 seconds, then auto-closes.<br>"
            "• <b>👁</b> (per effect): Opens the overlay with ONLY that one effect active for "
            "3 seconds, then restores previous settings.<br><br>"
            "<b>Effects are grouped by overlay (7 cards):</b><br>"
            ...
            "• 🔢 Flip Counter — breathing glow, counter spin, milestone burst, firework…<br>"
            "• 🔰 Status Badge — scan-in animation, glow sweep, color morph…<br><br>"
            "• <b>Enable All / Disable All</b>: Quick toggle for all 63 effects at once.<br>"
            ...
            "Effects use OpenGL GPU acceleration."
        ),
        "available_maps": (
